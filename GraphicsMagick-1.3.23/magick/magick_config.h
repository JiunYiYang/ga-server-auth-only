...
#define GM_BUILD_CC "c99"

/* CFLAGS used for C compilation */
#define GM_BUILD_CFLAGS "-fopenmp -O2 -Wall -pthread"

/* arguments passed to configure */
#define GM_BUILD_CONFIGURE_ARGS "./configure  'CC=c99' 'CFLAGS=-O2' 'LDFLAGS=-L/usr/local/lib' 'LIBS=-lfreetype'"

/* CPPFLAGS used for preprocessing */
#define GM_BUILD_CPPFLAGS "-I/usr/include/freetype2 -I/home/student/anaconda3/include/libxml2"
...
#define GM_BUILD_LDFLAGS "-L/usr/local/lib -L/home/student/anaconda3/lib"

/* LIBS used for linking */
#define GM_BUILD_LIBS "-lfreetype -lfreetype -lpng12 -lX11 -lxml2 -lz -lm -lgomp -lpthread"
...
#define MagickCoderModulesPath "/usr/local/lib/GraphicsMagick-1.3.23/modules-Q8/coders/"

/* Subdirectory of lib where coder modules are installed */
#define MagickCoderModulesSubdir "GraphicsMagick-1.3.23/modules-Q8/coders"

/* Location of filter modules */
#define MagickFilterModulesPath "/usr/local/lib/GraphicsMagick-1.3.23/modules-Q8/filters/"

/* Subdirectory of lib where filter modules are installed */
#define MagickFilterModulesSubdir "GraphicsMagick-1.3.23/modules-Q8/filters"

/* Directory where architecture-dependent configuration files live. */
#define MagickLibConfigPath "/usr/local/lib/GraphicsMagick-1.3.23/config/"

/* Subdirectory of lib where architecture-dependent configuration files live.
   */
#define MagickLibConfigSubDir "GraphicsMagick-1.3.23/config"

/* Directory where architecture-dependent files live. */
#define MagickLibPath "/usr/local/lib/GraphicsMagick-1.3.23/"

/* Subdirectory of lib where GraphicsMagick architecture dependent files are
   installed */
#define MagickLibSubdir "GraphicsMagick-1.3.23"

/* Directory where architecture-independent configuration files live. */
#define MagickShareConfigPath "/usr/local/share/GraphicsMagick-1.3.23/config/"

/* Subdirectory of lib where architecture-independent configuration files
   live. */
#define MagickShareConfigSubDir "GraphicsMagick-1.3.23/config"

/* Directory where architecture-independent files live. */
#define MagickSharePath "/usr/local/share/GraphicsMagick-1.3.23/"
